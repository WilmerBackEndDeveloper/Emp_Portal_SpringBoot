...
//    public Employee_BasicDetails updateEmployee(int id, Employee_BasicDetails details) {
//        Employee_BasicDetails updatedEmp = employeeBasicRepo.findById(id).orElse(null);
//        updatedEmp.setEmpname(details.getEmpname());
//        updatedEmp.setEmail(details.getEmail());
//        updatedEmp.setPhone(details.getPhone());
//        return employeeBasicRepo.save(updatedEmp);
//    }
